...
**extension.ts** orchestrates everything: command registration, lifecycle, binary file watcher for auto-refresh, bidirectional selection events, status bar.
...
- Предпочитать стандартные библиотеки Node.js (`child_process`, `fs`, `path`).
